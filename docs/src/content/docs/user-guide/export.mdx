...
<Tabs>
  ...
  <TabItem label="Markdown">
    **Best for:** Reading in note-taking apps (Obsidian, Notion, Bear), sharing with others, or archiving as plain text.
    ...
    The Markdown export produces a clean, human-readable document with YAML frontmatter metadata (`title`, `source`, `conversation_id`, etc.) and role-delimited message sections. Code blocks are preserved with language hints. Images are included as inline links or alt-text descriptions.
