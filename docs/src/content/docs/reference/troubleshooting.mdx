...
<Aside type="tip">
  To see these commands and more, run `haevnDebug.help()` in the Options page
  console.
</Aside>
...
If you encounter an issue not covered here, [open a GitHub issue](https://github.com/aiamblichus/haevn/issues) with:
