...
See the [charter/architecture/](https://github.com/yourusername/haevn/tree/main/charter/architecture/) directory in the repo for detailed architecture documents and Mermaid diagrams.
